...
// Wallet Icons
const MetaMaskIcon = () => (
    <Image src="/assets/MetaMask-icon-fox.svg" alt="MetaMask" width={24} height={24} />
)
...
const BrowserWalletIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className="size-6">
        <g clipPath="url(#clip0_browser)">
            ...
            <path d="M17.25 12V9.08333H7.91667C7.60725 9.08333 7.3105 8.96042 7.09171 8.74162C6.87292 8.52283 6.75 8.22609 6.75 7.91667C6.75 7.60725 6.87292 7.3105 7.09171 7.09171C7.3105 6.87292 7.60725 6.75 7.91667 6.75H16.0833V9.08333" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M6.75 7.91675V16.0834C6.75 16.3928 6.87292 16.6896 7.09171 16.9084C7.3105 17.1271 7.60725 17.2501 7.91667 17.2501H17.25V14.3334" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M15.4999 12C15.1905 12 14.8938 12.1229 14.675 12.3417C14.4562 12.5605 14.3333 12.8572 14.3333 13.1667C14.3333 13.4761 14.4562 13.7728 14.675 13.9916C14.8938 14.2104 15.1905 14.3333 15.4999 14.3333H17.8333V12H15.4999Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background: "linear-gradient(180deg, #FFC4A2 24%, #FFE4C0 70%, #F8F5F1 100%)",
                }}
            >
                <div className="flex min-h-screen">
                    ...
                    <div className="relative hidden max-w-lg shrink-0 flex-col items-start gap-8 bg-[#f7931a] p-16 text-white lg:flex">
                        <h2 className="text-4xl font-semibold">
                            Swap, deposit,<br />take the lead
                        </h2>
                        <p className="text-lg">
                            Megadrome is a <span className="font-semibold">decentralized exchange</span> where you can execute low-fee swaps, deposit tokens to earn rewards, and actively participate in the onchain economy.
                        </p>
                        <button
                            onClick={onClose}
                        ...
                        <Link href="/" onClick={onClose}>
                            ...
                            <div className="flex items-center gap-2">
                                <Image
                                    ...
                                    className="w-12 h-12"
                                />
                                <span className="text-gray-800 text-2xl font-semibold tracking-wide">megadrome</span>
                            </div>
                        </Link>
                            ...
                            <div className="flex w-full flex-col gap-5">
                                ...
                                <div className="text-xs text-gray-600">
                                    <p>
                                        ...
                                        <br />
                                        <span className="text-[#f7931a] font-medium">Monad Testnet</span> only.
                                    </p>
                                </div>
